...
todos:
  - id: create-standards-modules
    content: Create docs/standards/ directory and populate with extracted standards (rust.md, testing.md, solid.md, security.md, oop.md, git.md, context.md)
    status: pending
  - id: refactor-kernels
...
- **`docs/standards/context.md`**: **(NEW)** Context management, compaction strategies, and artifact-driven workflows.
...
## 4. Execution Steps
1.  **Modules:** Create `docs/standards/` and populate (including `context.md`).
