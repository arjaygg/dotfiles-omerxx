...
This plugin is in `/Users/axos-agallentes/git/claude-setup`.
...
/Users/axos-agallentes/git/claude-setup
```
...
1. **Reads the template** - Loads MCP server definitions from `/Users/axos-agallentes/git/team-insights/.mcp.json`
