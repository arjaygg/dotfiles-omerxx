...
| 03 | [Agentic Git Lifecycle Pipeline](2026-07-25-03-agentic-git-pipeline.md) | pending | Step 0 (Stop-hook contract spike) done, findings folded into plan; awaiting go-ahead for Step 1. See `plans/2026-07-25-agentic-git-pipeline.md` for the full D1-D7 decision record. |
