...
Use this file instead of the step-01..step-05 sequence when the full step-by-step read/execute
cadence is overkill (e.g. a small, well-understood feature, or a host that cannot hold multi-file
skill state). It reproduces the same behavior as the numbered steps in a single pass.
